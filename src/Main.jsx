          ...
          <div className="row m-0">
            <div className=" col-md-6 col-sm-12 m-0 p-0">
              <div className="header-txt">
                ...
                <h1>
                  When You're getting{" "}
                  <span style={{ color: "#dede14" }}>85%</span> Discount
                </h1>
